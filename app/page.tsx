...
export default function Home() {
  ...
  const runAction = (
    <Button className="run-button" disabled={!data || busy} onClick={run}>
      <Play size={16} />
        ...
        <div className="workspace-heading">
          <div>
            <div className="eyebrow">
              YOUR LOCAL WORKSPACE <span>/</span>{' '}
              {table.example ? 'EXPERIMENT 001' : 'YOUR DATASET'}
            </div>
            <h1>
              Make your mix make sense<span>.</span>
            </h1>
            <p>Explore what drives revenue. Put uncertainty in the picture.</p>
          </div>
        ...
        <Tabs value={tab} onValueChange={(v) => setTab(String(v))}>
          ...
          <TabsContent value="overview">
            <div className="metrics">
              ...
              <div>
                ...
                <p>{mapping.channels.length} channels · Original data units</p>
              </div>
              <div>
            ...
            <div className="main-grid">
              ...
              <section className="panel run-panel">
                ...
                <div className="eyebrow">
                  {busy ? 'BAYESIAN INFERENCE, LIVE' : 'FROM DATA TO EVIDENCE'}
                </div>
                <h2>
                  {busy ? (
                    'Finding the signal.'
            ...
            <div className="section-label">
              <h2>{posterior ? 'Your channel signals' : 'The ingredients'}</h2>
              <span>
                {posterior
            ...
            >
              {mapping.channels.map((name, i) => (
                <section className="panel channel-card" key={name}>
                  <div className="channel-top">
                    <div className="channel-icon" style={{ color: colors[i] }}>
              ...
              <button className="panel data-cta" onClick={() => setTab('data')}>
                <Database />
                <span>
                  Bring your own data
          ...
          <TabsContent value="data">
            <div className="section-intro">
              ...
              <p>
                Weekly observations. One outcome. The channels and controls that
                matter.
              </p>
            </div>
              ...
              <div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p>52–520 weekly rows · Up to 8 channels · 5 MB maximum</p>
                  </div>
                  <Button
                    variant="outline"
                    disabled={busy}
                ...
                <section className="panel mapping-panel">
                  <div className="panel-heading">
                    <div>
                      ...
                      <p>
                        Dates use YYYY-MM-DD. Numeric columns use plain numbers.
                      </p>
                    </div>
                  </div>
              ...
              <section className="panel model-controls">
                <div className="model-step">
                  ...
                  <div>
                    ...
                    <p>Geometric carryover, followed by logistic saturation.</p>
                  </div>
                </div>
                <Range
                ...
                <div className="two-fields">
                  ...
                  <div>
                    ...
                    <Picker
                      ...
                      disabled={busy}
                      onChange={(v) => changeConfig('targetAccept', Number(v))}
                    />
                  </div>
                </div>
              ...
              <div>
                ...
                <section className="panel ready-panel">
                  ...
                  <p>
                    ...
                    iterations, running locally. Keep this tab open while
                    fitting.
                  </p>
                  {runAction}
                  {!data && (
          ...
          <TabsContent value="scenarios">
            <div className="section-intro">
              ...
              <p>
                Replay the observed period with different channel budgets. Keep
            ...
            {!posterior || !data ? (
              <section className="panel scenario-empty">
                ...
                <p>
                  Fit a model to unlock budget sliders, channel response curves,
                  and uncertainty-aware comparisons.
                </p>
              ...
              <>
                ...
                <div className="scenario-layout">
                  ...
                  <section className="panel impact-panel">
                    ...
                    <p>
                      Change in average weekly modeled outcome, on the original
                      scale.
                    </p>
                    ...
                    <div className="scenario-assumptions">
                      ...
                      <p>
                        ...
                        Carryover is recomputed for the changed spend. This is a
                        historical counterfactual, not a forecast.
                      </p>
                    </div>
                  </section>
                </div>
                    ...
                    <TableBody>
                      {data.channels.map((c, i) => (
                        <TableRow key={c}>
                          ...
                          <TableCell>
                            {compact(simulation?.channels[i].changed.low ?? 0)}{' '}
                            –{' '}
                            {compact(simulation?.channels[i].changed.high ?? 0)}
                          </TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
            ...
            <div className="code-layout">
              ...
              <div className="code-escapes">
                <section className="panel escape-primary">
                  ...
                  <div className="eyebrow">STAY IN THE BROWSER. GO DEEPER.</div>
                ...
                <section className="panel notebook-panel">
                  ...
                  <p className="tiny">
                    ...
                    downloaded browser notebook there to use your own data; the
                    app does not upload it automatically.
                  </p>
                </section>
                <section className="panel fork-panel">
                  ...
                  <div>
                    ...
                    <p>
                      MIT licensed. Bring your own models, extend the interface,
                      or self-host.
                    </p>
